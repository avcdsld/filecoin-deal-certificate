...
const filecoinRpcUrl = 'https://api.hyperspace.node.glif.io/rpc/v1' // hyperspace testnet
const contractAddress = '0xADd4982D5f94559b86dD5887386AB7bb60836Acd'
const contractAbi = [
  {
    inputs: [],
  ...
  return (
    <>
      <div className="container bg-gray-100 font-body">
        <Head>
          <title>Filecoin Deal Certificate</title>
            ...
            <>
              <Center>
                <Box w="500">
                  ...
                  <img
                    src="https://i.imgur.com/H3BiGyG.png"
                    alt=""
                    width="300"
                    height="300"
                    style={{ display: 'block', margin: 'auto' }}
                  ...
                  <TableContainer>
                    <Table variant="simple" size={'lg'}>
                      ...
                      <Tbody>
                        <Tr>
                          <Td>Token ID</Td>
                          <Td>{certificate.tokenId}</Td>
                        </Tr>
                        <Tr>
                          <Td>Deal ID</Td>
                          <Td>{certificate.dealId}</Td>
                        </Tr>
                        {/* <Tr>
                      <Td>Data</Td>
                      <Td>{certificate.data}</Td>
                        ...
                        <Tr>
                          ...
                          <Td>{certificate.clientActorId}</Td>
                        </Tr>
                        <Tr>
                          <Td borderColor={'gray'}>Provider Actor Id</Td>
                          <Td borderColor={'gray'}>
                            {certificate.providerActorId}
                          </Td>
                        </Tr>
                      </Tbody>
                    </Table>
